...
class TestKheirkhahanGSD:
    ...
    def test_empty_input(self, version, cwb):
        ...
        gs_list = KheirkhahanGSD(version=version, cwb=cwb).detect(data, sampling_rate_hz=100).gs_list_
    ...
    def test_real_wrist_data(self, version, cwb):
        ...
        gs_list = KheirkhahanGSD(version=version, cwb=cwb).detect(imu_data, sampling_rate_hz=100).gs_list_
